...
На входе данные для трекинга (координаты точки в формате [долгота, широта], погрешность позиционирования в метрах, метод получения координат и уровернь заряда устройства):
...
Для оптимизации можно одновременно передать больше одной записи трекинга.
